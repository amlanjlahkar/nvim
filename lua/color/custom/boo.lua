...
M.custom = {
  ...
  { "TelescopeNormal",            { bg = BlackShadeLighter, fg = Fg } },
  { "TelescopeBorder",            { bg = BlackShadeLighter, fg = BlackShadeLighter } },
  { "TelescopePromptTitle",       { bg = BlackShadeLighter, fg = FgShadeDarker } },
  ...
  { "NormalFloat",                { bg = BlackShadeLighter, fg = Fg } },
  { "FloatBorder",                { bg = BlackShadeLighter, fg = BlackShadeLighter } },
  { "NormalFloatAlt",             { bg = BlackShadeLighter, fg = Fg } },
  { "FloatBorderAlt",             { bg = BlackShadeLighter, fg = BlackShadeLighter } },
